            ...
            <div class="card">
                                    ...
                                    <table class="table table-head-bg-primary">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data['detail'] as $key => $value )
                                                @php
                                                    $totalTerjual = $value->sold * $value->price;
                                                    $sisa = $value->qty - $value->sold;
                                                    $totalRugi = $sisa * $value->price;
                                                    $totalPendapatan += $totalTerjual;
                                                    $totalKerugian += $totalRugi;
                                                @endphp
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <b class="text-success">{{$value->sold}}</b>
                                                </td>
                                                <td class="text-center">
                                                    <b class="text-danger">{{$value->qty - $value->sold}}</b>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="mb-3">
                                <div class="form-control-plaintext">{{__('Total Pendapatan')}}</div>
                                <h3 class="text-success">{{formatRupiah($totalPendapatan)}}</h3>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="mb-3">
                                <div class="form-control-plaintext">{{__('Total Kerugian')}}</div>
                                <h3 class="text-danger">{{formatRupiah($totalKerugian)}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
